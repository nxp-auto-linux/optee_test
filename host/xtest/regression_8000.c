 ...
 */
#if !defined(CFG_HSE_PBKDF2_EXPORT_DERIVED_KEY_DBG) && !defined(CFG_HSE_EMBED_KEYHANDLES)
/* 1 */
static const uint8_t __maybe_unused pbkdf2_1_password[] = {
	'p', 'a', 's', 's', 'w', 'o', 'r', 'd'
};

static const uint8_t __maybe_unused pbkdf2_1_salt[] = {
	's', 'a', 'l', 't'
};

#define pbkdf2_1_iteration_count 1
static const uint8_t __maybe_unused pbkdf2_1_dkm[] = {
...
static const uint8_t __maybe_unused pbkdf2_2_dkm[] = {
...
static const uint8_t __maybe_unused pbkdf2_3_dkm[] = {
...
static const uint8_t __maybe_unused pbkdf2_4_dkm[] = {
...
/* 6 */
static const uint8_t __maybe_unused pbkdf2_6_password[] = {
	'p', 'a', 's', 's', '\0', 'w', 'o', 'r',
	'd',
};

static const uint8_t __maybe_unused pbkdf2_6_salt[] = {
	's', 'a', '\0', 'l', 't'
};

#define pbkdf2_6_iteration_count 4096
static const uint8_t __maybe_unused pbkdf2_6_dkm[] = {
	0x56, 0xfa, 0x6a, 0xa7, 0x55, 0x48, 0x09, 0x9d,
	0xcc, 0x37, 0xd7, 0xf0, 0x34, 0x25, 0xe0, 0xc3
};
#endif /* !CFG_HSE_PBKDF2_EXPORT_DERIVED_KEY_DBG && !CFG_HSE_EMBED_KEYHANDLES */
...
/* The default implementation is statically defined in this file.
 * The implementation for CFG_HSE_PBKDF2_EXPORT_DERIVED_KEY_DBG is in regression_8000_pbkdf2_dbg.c
 * The implementation for CFG_HSE_EMBED_KEYHANDLES is inregression_8000_pbkdf2_ekh.c
 */
...
/* Fall back to the (xtest original) software implementation. */
void xtest_test_derivation_pbkdf2(ADBG_Case_t *c, TEEC_Session *session)
{
	size_t n;
#define RFC6070_TEST(l, n, run) \
	TEST_PBKDF2_DATA(l, "RFC 6070 " TO_STR(n) " (HMAC-SHA1)", \
			 TEE_ALG_PBKDF2_HMAC_SHA1_DERIVE_KEY, n, false, run)
	static struct pbkdf2_case pbkdf2_cases[] = {
		RFC6070_TEST(0, 1, true),
		RFC6070_TEST(0, 2, true),
		RFC6070_TEST(0, 3, true),
		RFC6070_TEST(15, 4, true), /* Lengthy! (2 min on HiKey @1.2GHz) */
		RFC6070_TEST(0, 5, true),
		RFC6070_TEST(0, 6, true)
	};
...
#endif /* !CFG_HSE_EMBED_KEYHANDLES && !CFG_HSE_PBKDF2_EXPORT_DERIVED_KEY_DBG */
